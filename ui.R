  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "pgeh",
              fluidRow(
                box(selectInput(inputId = "pgehselectInput1", label = "Select dataset", choices = c('NB88',
                                                                                                    'HI51',
                                                                                                    'IH250',
                                                                                                    'OBER649',
                                                                                                    'GPL8300 (GSE3960)'='GPL8300',
                                                                                                    'GPL6102 (GSE19274)'='GPL6102')),
      ...
      tabItem(tabName = "pgebp",
              fluidRow(
                box(selectInput(inputId = "pgebpselectInput1", label = "Select dataset", choices = c('NB88',
                                                                                                     'HI51',
                                                                                                     'IH250',
                                                                                                     'OBER649',
                                                                                                     'GPL8300 (GSE3960)'='GPL8300',
