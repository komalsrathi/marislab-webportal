  ...
  dashboardSidebar(width = 400,
    ...
    sidebarMenu(
      ...
      menuItem("TARGET RNASeq Multi-Tumor Comparison", tabName = "targetrnaseq", icon = icon("gears"),
               menuSubItem("Target Database", icon = icon("database"), tabName = "tgedata"),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "cldb",
              fluidRow(
                box(selectInput(inputId = 'cldbselectInput1', label = 'Select dataset',choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                   'Microarray U133Plus2 Sanger CLE (n=29)'='Microarray_RMA_U133Plus2_29cells_genes',
                                                                                                   'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes',
                                                                                                   'Microarray HumanWG6v2 GSE19274 (n=38)'='Microarray_RMA_HumanWG6v2_38cells_genes',
                                                                                                   'RNAseq (STAR) (n=41)'='STAR_FPKM_41cells_genes',
                                                                                                   'RNAseq (Kallisto) (n=41)'='kallisto_TPM_41cells_genes',                                 
                                                                                                   'RNAseq (STAR) (n=46)'='STAR_FPKM_46cells_genes')), width = 5, background = "navy")
              ),
      ...
      tabItem(tabName = "clge",
              fluidRow(
                box(selectInput(inputId = "clgeselectInput1", label = "Select dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                    'Microarray U133Plus2 Sanger CLE (n=29)'='Microarray_RMA_U133Plus2_29cells_genes',
                                                                                                    'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes',
                                                                                                    'Microarray HumanWG6v2 GSE19274 (n=38)'='Microarray_RMA_HumanWG6v2_38cells_genes',
                                                                                                    'RNAseq (STAR) (n=41)'='STAR_FPKM_41cells_genes',
                                                                                                    'RNAseq (Kallisto) (n=41)'='kallisto_TPM_41cells_genes',
                                                                                                    'RNAseq (STAR) (n=46)'='STAR_FPKM_46cells_genes')),
      ...
      tabItem(tabName = "clggc",
              fluidRow(
                box(selectInput(inputId = "clggcselectInput1", label = "Select dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                     'Microarray U133Plus2 Sanger CLE (n=29)'='Microarray_RMA_U133Plus2_29cells_genes',
                                                                                                     'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes',
                                                                                                     'Microarray HumanWG6v2 GSE19274 (n=38)'='Microarray_RMA_HumanWG6v2_38cells_genes',
                                                                                                     'RNAseq (STAR) (n=41)'='STAR_FPKM_41cells_genes',
      ...
      tabItem(tabName = "clgcn",
              fluidRow(
                box(selectInput(inputId = "clgcnselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                     'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes')),
      ...
      tabItem(tabName = "clcvm",
              fluidRow(
                box(selectInput(inputId = "clcvmselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                     'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes'), selected = NULL),
      ...
      tabItem(tabName = "clh",
              fluidRow(
                box(selectInput(inputId = "clhselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                   'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes')), width = 3, background = "navy"),
      ...
      tabItem(tabName = "clct",
              fluidRow(
                box(selectInput(inputId = "clctselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=29)'='Microarray_RMA_HumanGene1.0ST_29cells_genes',
                                                                                                    'Microarray U133Plus2 CCLE (n=17)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes')), width = 3, background = "navy"),
      ...
      tabItem(tabName = "psdb",
              fluidRow(
                box(selectInput(inputId = 'psdbselectInput1', label = 'Select dataset',choices = c('NB88 (n=88)'='NB88',
                                                                                                   'HI51 (n=51)'='HI51',
                                                                                                   'IH250 (n=250)'='IH250',
                                                                                                   'OBER649 (n=649)'='OBER649',
                                                                                                   'GSE3960 (GPL8300 U95, n=101)'='GSE3960',
                                                                                                   'GSE19274 (GPL6102 HumanWG6v2, n=100)'='GSE19274',
                                                                                                   'GSE16237 (GPL570 U133Plus2, n=51)'='GSE16237',
                                                                                                   'GSE45547 (GPL16876 Custom44k, n=649)'='GSE45547',
                                                                                                   'GSE13136 (GPL570 U133Plus2, n=30)'='GSE13136',
                                                                                                   'GSE54720 (GPL13667	U219, n=23)'='GSE54720',
                                                                                                   'GSE49710 (GPL16876	Custom44k, n=11)'='GSE49710',
                                                                                                   'GSE27608 (GPL5188 HuEx1.0ST, n=47)'='GSE27608',
                                                                                                   'GSE16476 (GPL570	U133Plus2.0, n=88)'='GSE16476',
                                                                                                   'EMEXP669 (GPL96 U133A, n=24)'='EMEXP669',
                                                                                                   'GSE3446 (GPL96 U133A, n=117)'='GSE3446_U133A',
                                                                                                   'GSE3446 (GPL97 U133B, n=117)'='GSE3446_U133B',
                                                                                                   'GSE49711 (GPL17553	IlluminaHiseq2000, n=498)'='GSE49711_FPKM',
                                                                                                   'GSE65303 (GPL16876	Custom44k, n=18)'='GSE65303',
                                                                                                   'TARGET NBL (HUEX10, n=249)'='TARGET_NBL')), width = 5, background = "navy")
              ),
      ...
      tabItem(tabName = "pgeh",
              fluidRow(
                box(selectInput(inputId = "pgehselectInput1", label = "Select dataset", choices = c('NB88 (n=88)'='NB88',
                                                                                                    'HI51 (n=51)'='HI51',
                                                                                                    'IH250 (n=250)'='IH250',
                                                                                                    'OBER649 (n=649)'='OBER649',
                                                                                                    'GSE3960 (GPL8300 U95, n=101)'='GSE3960',
                                                                                                    ...
                                                                                                    'GSE49711 (GPL17553	IlluminaHiseq2000, n=498)'='GSE49711_FPKM',
                                                                                                    'GSE65303 (GPL16876	Custom44k, n=18)'='GSE65303',
                                                                                                    'TARGET NBL (HUEX10, n=249)'='TARGET_NBL')),
      ...
      tabItem(tabName = "pgebp",
              fluidRow(
                box(selectInput(inputId = "pgebpselectInput1", label = "Select dataset", choices = c('NB88 (n=88)'='NB88',
                                                                                                     'HI51 (n=51)'='HI51',
                                                                                                     'IH250 (n=250)'='IH250',
                                                                                                     'OBER649 (n=649)'='OBER649',
                                                                                                     'GSE3960 (GPL8300 U95, n=101)'='GSE3960',
      ...
      tabItem(tabName = "pkm",
              fluidRow(
                box(selectInput(inputId = "pkmselectInput1", label = "Select dataset", choices = c('NB88 (n=88)',
                                                                                                   'IH250 (n=250)',
                                                                                                   'GSE3960 (GPL8300 U95, n=101)'='GSE3960')),
      ...
      tabItem(tabName = "pggc",
              fluidRow(
                box(selectInput(inputId = "pggcselectInput1", label = "Select dataset", choices = c('NB88 (n=88)'='NB88',
                                                                                                    'HI51 (n=51)'='HI51',
                                                                                                    'IH250 (n=250)'='IH250',
                                                                                                    'OBER649 (n=649)'='OBER649',
                                                                                                    'GSE3960 (GPL8300 U95, n=101)'='GSE3960',
      ...
      tabItem(tabName = "pmcg",
              fluidRow(
                box(selectInput(inputId = "pmcgselectInput1", label = "Select dataset", choices = c('NB88 (n=88)'='NB88',
                                                                                                    'HI51 (n=51)'='HI51',
                                                                                                    'IH250 (n=250)'='IH250',
                                                                                                    'OBER649 (n=649)'='OBER649',
                                                                                                    'GSE3960 (GPL8300 U95, n=101)'='GSE3960',
      ...
      tabItem(tabName = "tgedata",
              fluidRow(
                box(selectInput(inputId = "tgedataselectInput1", label = 'Select dataset', choices = c('TARGET RNAseq (STAR) (n=724)'='STAR_FPKM_Target724_genes',
                                                                                                       'TARGET RNAseq (Kallisto) (n=724)'='kallisto_TPM_Target724_genes')), width = 5, background = "navy")
                ),
      ...
      tabItem(tabName = "tgebox",
              fluidRow(
                box(selectInput(inputId = "tgeboxselectInput1", label = "Select dataset", choices = c('TARGET RNAseq (STAR) (n=724)'='STAR_FPKM_Target724_genes',
                                                                                                      'TARGET RNAseq (Kallisto) (n=724)'='kallisto_TPM_Target724_genes')),
      ...
      tabItem(tabName = "tgedot",
              fluidRow(
                box(selectInput(inputId = "tgedotselectInput1", label = "Select dataset", choices = c('TARGET RNAseq (STAR) (n=724)'='STAR_FPKM_Target724_genes',
                                                                                                      'TARGET RNAseq (Kallisto) (n=724)'='kallisto_TPM_Target724_genes')),
