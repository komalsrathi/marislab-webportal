...
dashboardPage(
  ...
  dashboardSidebar(width = 400,
    ...
    sidebarMenu(
      ...
      menuItem("Data Description", icon = icon("database"), tabName = "datadesc"),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "cldb",
              fluidRow(
                box(selectInput(inputId = 'cldbselectInput1', label = 'Select dataset',choices = c('Microarray HumanGene1.0 ST (n=28, RMA)'='Microarray_RMA_HumanGene1.0ST_28cells_genes',
      ...
      tabItem(tabName = "clge",
              fluidRow(
                box(selectInput(inputId = "clgeselectInput1", label = "Select dataset", choices = c('Microarray HumanGene1.0 ST (n=28, RMA)'='Microarray_RMA_HumanGene1.0ST_28cells_genes',
                                                                                                    'Microarray U133Plus2 Sanger CLE (n=29, RMA)'='Microarray_RMA_U133Plus2_29cells_genes',
                                                                                                    'Microarray U133Plus2 Broad CCLE (n=17, RMA)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes',
                                                                                                    'Microarray HumanWG6v2 GSE19274 (n=37, RMA)'='Microarray_RMA_HumanWG6v2_37cells_genes',
                                                                                                    'CL RNAseq (Kallisto) (n=40, TPM)'='kallisto_TPM_40cells_genes',
      ...
      tabItem(tabName = "clggc",
              fluidRow(
                box(selectInput(inputId = "clggcselectInput1", label = "Select dataset", choices = c('Microarray HumanGene1.0 ST (n=28, RMA)'='Microarray_RMA_HumanGene1.0ST_28cells_genes',
                                                                                                     'Microarray U133Plus2 Sanger CLE (n=29, RMA)'='Microarray_RMA_U133Plus2_29cells_genes',
                                                                                                     'Microarray U133Plus2 Broad CCLE (n=17, RMA)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes',
                                                                                                     'Microarray HumanWG6v2 GSE19274 (n=37, RMA)'='Microarray_RMA_HumanWG6v2_37cells_genes',
                                                                                                     'CL RNAseq (Kallisto) (n=40, TPM)'='kallisto_TPM_40cells_genes',
      ...
      tabItem(tabName = "clh",
              fluidRow(
                box(selectInput(inputId = "clhselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=28, RMA)'='Microarray_RMA_HumanGene1.0ST_28cells_genes',
      ...
      tabItem(tabName = "clct",
              fluidRow(
                box(selectInput(inputId = "clctselectInput1", label = "Choose dataset", choices = c('Microarray HumanGene1.0 ST (n=28, RMA)'='Microarray_RMA_HumanGene1.0ST_28cells_genes',
                                                                                                    'Microarray U133Plus2 Broad CCLE (n=17, RMA)'='Microarray_RMA_U133Plus2_17cells_CCLE_genes')), width = 3, background = "navy"),
                box(selectInput(inputId = "clctselectInput2", label = "Set 1", choices = c("None"), multiple = TRUE), width = 3, background = "navy"),
                box(selectInput(inputId = "clctselectInput3", label = "Set 2", choices = c("None"), multiple = TRUE), width = 3, background = "navy"),
      ...
      tabItem(tabName = "pptcmut",
              fluidRow(
                box(selectInput(inputId = "pptcmutselectInput1", label = "Select dataset", choices = c("PPTC Exome Calls"="ExomeCallsPPTC")),
      ...
      tabItem(tabName = "psdb",
              fluidRow(
                box(selectInput(inputId = 'psdbselectInput1', label = 'Select dataset',choices = c('GSE16476 (GPL570	U133Plus2.0, n=88, RMA)'='NB88',
                                                                                                   ...
                                                                                                   'GSE54720 (GPL13667	U219, n=23, RMA)'='GSE54720',
                                                                                                   'GSE49710 (GPL16876	Custom44k, n=498, RMA)'='GSE49710',
                                                                                                   'GSE27608 (GPL5188 HuEx1.0ST, n=47, RMA)'='GSE27608',
                                                                                                   'EMEXP669 (GPL96 U133A, n=24, RMA)'='EMEXP669',
                                                                                                   'GSE3446 (GPL96 U133A, n=117, RMA)'='GSE3446_U133A',
                                                                                                   'GSE3446 (GPL97 U133B, n=117, RMA)'='GSE3446_U133B',
                                                                                                   ...
                                                                                                   'TARGET NBL MIRNA (RNAseq, n=151, RPKM)'='TARGET_MIRNA_FPKM')), width = 5, background = "navy")
              ),
      ...
      tabItem(tabName = "pgeh",
              fluidRow(
                box(selectInput(inputId = "pgehselectInput1", label = "Select dataset", choices = c('GSE16476 (GPL570	U133Plus2.0, n=88, RMA)'='NB88',
                                                                                                    ...
                                                                                                    'TARGET NBL PST (RNAseq, n=151, STAR FPKM)'='TARGET_NBL_FPKM_PST',
                                                                                                    'TARGET NBL RST (RNAseq, n=7, STAR FPKM)'='TARGET_NBL_FPKM_RST',
                                                                                                    'TARGET NBL MIRNA (RNAseq, n=151, RPKM)'='TARGET_MIRNA_FPKM')),
      ...
      tabItem(tabName = "pgcn",
              fluidRow(
                box(selectInput(inputId = "pgcnselectInput1", label = "Select dataset", choices = c('IH250', 'TARGET_NBL')),
      ...
      tabItem(tabName = "pgcvm",
              fluidRow(
                box(selectInput(inputId = "pgcvmselectInput1", label = "Select dataset", choices = c('IH250', 'TARGET_NBL')),
